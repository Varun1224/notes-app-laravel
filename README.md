# notes-app-laravel
This is a simple notes app that allows you to create, edit, delete, and update your notes, featuring login and authentication functionality built with Laravel.
